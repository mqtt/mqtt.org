...
<section class="accordion-wrapper software" style="margin-bottom: 50px;">
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://theakiro.com/"><h3>Akiro by Sentienz</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://activemq.apache.org/index.html"><h3>Apache ActiveMQ</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/activemq.png' | relative_url }}" class="software-logo">
         <div><a href="http://activemq.apache.org/artemis/"><h3>Apache ActiveMQ Artemis</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://www.bevywise.com/mqtt-broker/"><h3>Bevywise MQTT Broker</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/mtsoleimani/cassandana/"><h3>Cassandana</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://www.process-one.net/en/ejabberd"><h3>ejabberd</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://emitter.io"><h3>Emitter</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://www.emqx.io/products/broker"><h3>EMQ X</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/alekras/erl.mqtt.server"><h3>Erl.mqtt.server</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://www.eurotech.com/en/solutions/device+to+cloud/mqtt+protocol"><h3>Eurotech Everywhere Device Cloud</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://flespi.com/mqtt-broker"><h3>flespi</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/beerfactory/hbmqtt"><h3>HBMQTT</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://github.com/Cicizz/jmqtt"><h3>Jmqtt</h3></a>
      ...
      <div class="panel-item">
         ...
         <div><a href="https://www.ibm.com/cloud/app-connect"><h3>IBM Integration Bus</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/ibm.png' | relative_url }}" class="software-logo">
         <div><a href="https://www.ibm.com/us-en/marketplace/watson-iot-platform-message-gateway"><h3>IBM WIoTP Message Gateway</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/ibm.png' | relative_url }}" class="software-logo">
         <div><a href="https://www.ibm.com/support/knowledgecenter/en/SSFKSJ_7.5.0/com.ibm.mq.pro.doc/q001030_.htm"><h3>IBM Websphere MQ Telemetry</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="http://mqtt.jorammq.com"><h3>JoramMQ</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://litmusautomation.com/"><h3>Litmus Automation Loop</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/andsel/moquette"><h3>Moquette</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://github.com/mcollina/mosca"><h3>Mosca</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://myqtthub.com/"><h3>MyQttHub.com</h3></a>
            Mosquitto is an Open Source MQTT server. A public, hosted test server is also available (more information).
         </div>
      </div>
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="https://github.com/chkr1011/MQTTnet/"><h3>MQTTnet</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/Wizzercn/MqttWk"><h3>MqttWk</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://rabbitmq.com/"><h3>RabbitMQ</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://dev.solacesystems.com/tech/"><h3>Solace</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://www.swiftmq.com/landing/router/index.html"><h3>SwiftMQ</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://thingscale.io/index_en.html"><h3>ThingScale IoT message broker</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         ...
         <div><a href="http://verne.mq/"><h3>VerneMQ</h3></a>
   ...
   <!-- Entry -->
      <div class="panel-item">
         <img src="{{ 'assets/img/software/mqtt.png' | relative_url }}" class="software-logo">
         <div><a href="https://github.com/GruppoFilippetti/vertx-mqtt-broker"><h3>Vert.x MQTT Broker</h3></a>
